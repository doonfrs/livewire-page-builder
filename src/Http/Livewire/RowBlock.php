    ...
    public function getPageBuilderProperties(): array
    {
        ...
        return [
            ...
            new SelectProperty(
                ...
                options: [
                    '' => __('None'),
                    'justify-start' => __('Start'),
                    'justify-center' => __('Center'),
                    'justify-end' => __('End'),
                    'justify-between' => __('Space Between'),
                    'justify-around' => __('Space Around'),
                    'justify-evenly' => __('Space Evenly'),
                ],
            ),
            new SelectProperty(
                name: 'alignItems',
                ...
                options: [
                    '' => __('None'),
                    'items-start' => __('Start'),
                    'items-center' => __('Center'),
                    'items-end' => __('End'),
                    'items-baseline' => __('Baseline'),
                    'items-stretch' => __('Stretch'),
                ],
            ),
            new SelectProperty(
                name: 'overflowX',
            ...
            new SelectProperty(
                ...
                options: [
                    'content-start' => __('Top'),
                    'content-center' => __('Center'),
                    'content-end' => __('Bottom'),
                    'content-stretch' => __('Stretch'),
                ],
            ),
            (new SelectProperty(
            ...
            ))->setGroup('contentWidth', __('Content Width'), 3, 'heroicon-o-rectangle-group'),
            (new SelectProperty(
            ...
            (new SelectProperty(
                ...
                options: $gapOptions,
            ))->setGroup('gap', __('Gap'), 3, 'heroicon-o-rectangle-group'),
            (new SelectProperty(
                name: 'tabletGap',
                label: __('Tablet'),
