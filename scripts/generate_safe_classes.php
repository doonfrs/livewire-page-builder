...
function showHelp(): void
{
    ...
    echo "Options:\n";
    echo "  --type=TYPE       Type of classes to generate (all, height, min-height, width, min-width, padding, margin, grid, gap, flex, visibility, position, overflow, colors, shadows, backdrop-filters, filters, alignment, complete) [default: all]\n";
