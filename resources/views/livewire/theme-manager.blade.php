    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Theme Manager</h1>
                    <p class="mt-2 text-gray-600 dark:text-gray-400">
                        Manage your page builder themes. Select a theme to work with or create new ones.
                    </p>
                </div>
                    ...
                    <div class="px-6 py-4">
                        <div
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Preview</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="px-6 pb-6 space-y-2">
                        ...
                        <div class="flex space-x-2">
                            <button wire:click="openEditModal({{ $theme['id'] }})"
                                class="flex-1 inline-flex items-center justify-center px-3 py-1.5 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg transition-all duration-150">
                                <x-heroicon-o-pencil class="w-4 h-4 mr-1" />
                                Edit
                            </button>
                            @if ($defaultThemeId != $theme['id'])
                                <button wire:click="confirmSetDefaultTheme({{ $theme['id'] }})"
                                    class="flex-1 inline-flex items-center justify-center px-3 py-1.5 bg-yellow-100 dark:bg-yellow-900/30 hover:bg-yellow-200 dark:hover:bg-yellow-900/50 text-yellow-700 dark:text-yellow-400 text-sm font-medium rounded-lg transition-all duration-150">
                                    <x-heroicon-o-star class="w-4 h-4 mr-1" />
                                    Default
                                </button>
                            @endif
                            <button wire:click="confirmDeleteTheme({{ $theme['id'] }})"
                                class="flex-1 inline-flex items-center justify-center px-3 py-1.5 bg-red-100 dark:bg-red-900/30 hover:bg-red-200 dark:hover:bg-red-900/50 text-red-700 dark:text-red-400 text-sm font-medium rounded-lg transition-all duration-150">
            ...
            @empty
                ...
                <div class="col-span-full">
                    <div class="text-center py-12">
                        ...
                        <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">No themes yet</h3>
                        <p class="mt-2 text-gray-600 dark:text-gray-400">Get started by creating your first theme.</p>
                        <button wire:click="openCreateModal"
                ...
                <form wire:submit="createTheme">
                        ...
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div class="mt-4 space-y-4">
                                    <div>
                                        <label for="name"
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">Theme
                                            Name</label>
                                    ...
                                    <div>
                                        ...
                                        <textarea wire:model="description" id="description" rows="3"
                                            class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:ring-pink-500 focus:border-pink-500 sm:text-sm"
                                            placeholder="Describe this theme..."></textarea>
                                        @error('description')
                                            <span class="text-red-500 text-xs">{{ $message }}</span>
                                        @enderror
                                    </div>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        ...
                        <button type="button" wire:click="closeCreateModal"
                            class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 dark:border-gray-600 shadow-sm px-4 py-2 bg-white dark:bg-gray-800 text-base font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                            Cancel
                        </button>
                    </div>
                </form>
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500 dark:text-gray-400">
                                    ...
                                    @endif
                                    as the default theme? This will be used automatically when no theme is selected.
                                </p>
                            </div>
                        </div>
                    </div>
