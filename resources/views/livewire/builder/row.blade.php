        ...
        <div
            ...
            <button wire:click="rowSelected()"
                ...
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.042 21.672 13.684 16.6m0 0-2.51 2.225.569-9.47 5.227 7.917-3.286-.672ZM12 2.25V4.5m5.834.166-1.591 1.591M20.25 10.5H18M7.757 14.743l-1.59 1.59M6 10.5H3.75m4.007-4.243-1.59-1.59" />
                </svg>
            </button>
        ...
        <div x-data="{ open: false }"
            ...
            <div x-show="open" x-transition:enter="transition ease-out duration-200"
                ...
                <button wire:click="rowSelected()" @click="open = false"
                    ...
                    title="{{ __('Select Row') }}">
                    <svg class="w-4 h-4 ms-0 me-3 rtl:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.042 21.672 13.684 16.6m0 0-2.51 2.225.569-9.47 5.227 7.917-3.286-.672ZM12 2.25V4.5m5.834.166-1.591 1.591M20.25 10.5H18M7.757 14.743l-1.59 1.59M6 10.5H3.75m4.007-4.243-1.59-1.59" />
                    </svg>
                    <span>{{ __('Select') }}</span>
                </button>
                ...
                <button wire:click="copyRow()" @click="open = false"
                    class="flex items-center w-full px-3 py-2 text-left text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700 border-b border-gray-50 dark:border-gray-700"
                    title="{{ __('Copy Row') }}">
                    <svg class="w-4 h-4 ms-0 me-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="flex space-x-2 rtl:space-x-reverse">
                        <button
                            ...
                            <svg class="w-3 h-3 inline-block" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19.5v-15m0 0-6.75 6.75M12 4.5l6.75 6.75" />
                            </svg>
                            {{ __('Before') }}
                        </button>
                        <button
                            ...
                            <svg class="w-3 h-3 inline-block" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.5v15m0 0 6.75-6.75M12 19.5l-6.75-6.75" />
                            </svg>
                            {{ __('After') }}
                        </button>
                    </div>
                ...
                <div
                    ...
                    <div class="flex items-center flex-1">
                        <svg class="w-4 h-4 ms-0 me-3 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.5v15m7.5-7.5h-15" />
                        </svg>
                ...
                "
                    ...
                    title="{{ __('Remove Row') }}">
                    <svg class="w-4 h-4 ms-0 me-3 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
